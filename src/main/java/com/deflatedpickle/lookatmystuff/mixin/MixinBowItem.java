...
public class MixinBowItem implements BodyRender {
  ...
  public Vec3f getScale(@NotNull PlayerData data) {
    return BodyBowItem.INSTANCE.getScale(data);
  }

  @NotNull
  @Override
  public Vec3d getTranslation(@NotNull PlayerData data) {
    return BodyBowItem.INSTANCE.getTranslation(data);
  }

  @NotNull
  @Override
  public Vec3f getRotation(@NotNull PlayerData data) {
    return BodyBowItem.INSTANCE.getRotation(data);
  }

  @NotNull
  @Override
  public ModelTransformation.Mode getRenderMode(@NotNull PlayerData data) {
    return BodyBowItem.INSTANCE.getRenderMode(data);
  }
  ...
  public ModelPart getModelPart(
    ...
    return BodyBowItem.INSTANCE.getModelPart(model, data);
  }
}
